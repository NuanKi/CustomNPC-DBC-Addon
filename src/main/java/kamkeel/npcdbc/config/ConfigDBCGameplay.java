...
public class ConfigDBCGameplay
{
    ...
    public final static String Weakened_Spirit = "Weakened_Spirit";
    public static boolean WeakenedSpirit = true;
    ...
    public static void init(File configFile)
    {
        ...
        try
        {
            ...
            WeakenedSpirit = config.get(Weakened_Spirit, "Enable Weakened Spirit", true, "Enables Weakened Spirit when dying").getBoolean(true);
