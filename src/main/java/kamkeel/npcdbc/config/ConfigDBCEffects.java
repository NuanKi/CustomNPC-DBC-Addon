...
public class ConfigDBCEffects
{
    ...
    public static int OWRegenPercent = 5;
    ...
    public static void init(File configFile)
    {
        ...
        try
        {
            ...
            OWRegenPercent = config.get(REGEN, "Otherworld Regen", 5, "Percentage of restoration for Ki, stamina, and HP in the Otherworld.").getInt(5);
